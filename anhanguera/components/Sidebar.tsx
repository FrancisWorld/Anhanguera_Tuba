...
import { ArrowLeftOnRectangleIcon, ChatBubbleLeftEllipsisIcon } from "@heroicons/react/24/solid";
...
function Sidebar() {
  ...
  return (
    <div className="p-2 xl:flex hidden flex-col h-screen overflow-hidden">
      ...
      >
        <div onClick={logout} className='flex w-[100%] justify-start mx-auto cursor-pointer'>
